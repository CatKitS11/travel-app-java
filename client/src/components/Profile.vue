    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="mb-6">
            <button @click="$router.back()"
                ...
                <span class="text-2xl pb-1 pr-1">&larr;</span>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input v-model="editForm.firstName" type="text"
                                    class="w-full px-4 py-2 rounded-xl bg-card border border-border focus:ring-2 focus:ring-primary/20 outline-none" />
                            </div>
                            <div>
                            ...
                            <div class="opacity-50 pointer-events-none">
                                ...
                                <input :value="profile.email" type="text"
                                    class="w-full px-4 py-2 rounded-xl bg-muted border border-border outline-none"
                                    disabled />
                            </div>
                        </div>
